...
class ATBDP_Order
{
    public function __construct() {
        ...
        add_action( 'save_post_at_biz_dir', [$this, 'sync_order_author_on_listing_update'], 10, 3 );
    ...
    public function admin_footer_edit() {
        ...
        if ( 'atbdp_orders' == $post_type ) {
            ...
            <script type="text/javascript">
                var atbdp_bulk_actions = <?php echo wp_json_encode( atbdp_get_payment_bulk_actions() ); ?>;
                /*$actions = array(
    ...
    public function load_edit() {
        ...
        if ( 'atbdp_orders' == $typenow ) {
            ...
            $sendback = add_query_arg( [$action => $modified, 'ids' => join( ',', $post_ids )], $sendback );
