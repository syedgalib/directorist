...
class License {
        ...
        <div class="wrap appsero-license-settings-wrapper">
            ...
            <div class="appsero-license-settings appsero-license-section">
                ...
                <div class="appsero-license-details">
                    <p>
                        <?php printf( $this->client->_trans( 'Activate <strong>%s</strong> by your license key to get professional support and automatic update from your WordPress dashboard.' ), $this->client->name ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                    </p>
                    <form method="post" novalidate="novalidate" spellcheck="false">
                        ...
                        <div class="license-input-fields">
                            ...
                            <button type="submit" name="submit" class="<?php echo 'deactive' === $action ? 'deactive-button' : ''; ?>">
                                <?php echo $action === 'active' ? $this->client->_trans( 'Activate License' ) : $this->client->_trans( 'Deactivate License' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                            </button>
                        </div>
                    </form>
            ...
            <div class="single-license-info">
                ...
                <?php } else { ?>
                    <p class="<?php echo $license['remaining'] ? '' : 'occupied'; ?>">
                        <?php printf( $this->client->_trans( '%1$d out of %2$d' ), $license['remaining'], $license['activation_limit'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                    </p>
                <?php } ?>
            </div>
            <div class="single-license-info">
                ...
                if ( false !== $license['expiry_days'] ) {
                    ...
                    echo '<p class="' . $occupied . '">' . $license['expiry_days'] . ' days</p>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                } else {
                    echo '<p>' . $this->client->_trans( 'Never' ) . '</p>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                }
                ?>
            </div>
        </div>
    ...
    private function show_license_page_notices() {
        ...
        if ( ! empty( $this->success ) ) {
            ...
            <div class="notice notice-success is-dismissible appsero-license-section">
                <p><?php echo $this->success; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
            </div>
            <?php
        }
        echo '<br />';
    ...
    private function show_license_page_card_header( $license ) {
        ...
        <div class="appsero-license-title">
            ...
            <span><?php echo $this->client->_trans( 'Activate License' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
            ...
            <form method="post" class="appsero-license-right-form" novalidate="novalidate" spellcheck="false">
                ...
                <button type="submit" name="submit" class="appsero-license-refresh-button">
                    ...
                    <?php echo $this->client->_trans( 'Refresh License' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                </button>
            </form>
            <?php } ?>
